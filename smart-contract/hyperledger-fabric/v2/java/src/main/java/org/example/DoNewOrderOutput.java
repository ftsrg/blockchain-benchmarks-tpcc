...
public final class DoNewOrderOutput {
  @Property() public final int w_id;
  @Property() public final int d_id;
  @Property() public final int c_id;
  @Property() public final String c_last;
  @Property() public final String c_credit;
  @Property() public final Double c_discount;
  @Property() public final Double w_tax;
  @Property() public final Double d_tax;
  @Property() public final int o_ol_cnt;
  @Property() public final int o_id;
  @Property() public final String o_entry_d;
  @Property() public final Double total_amount;
  @Property() public final List<ItemsData> items;

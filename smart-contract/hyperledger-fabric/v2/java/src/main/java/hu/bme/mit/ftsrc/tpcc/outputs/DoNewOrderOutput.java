...
import hu.bme.mit.ftsrc.tpcc.entries.ItemsData;

// import com.owlike.genson.annotation.JsonProperty;

@DataType()
public final class DoNewOrderOutput {
  @Property() private final int w_id;
  @Property() private final int d_id;
  @Property() private final int c_id;
  @Property() private final String c_last;
  @Property() private final String c_credit;
  @Property() private final Double c_discount;
  @Property() private final Double w_tax;
  @Property() private final Double d_tax;
  @Property() private final int o_ol_cnt;
  @Property() private final int o_id;
  @Property() private final String o_entry_d;
  @Property() private final Double total_amount;
  @Property() private final List<ItemsData> items;

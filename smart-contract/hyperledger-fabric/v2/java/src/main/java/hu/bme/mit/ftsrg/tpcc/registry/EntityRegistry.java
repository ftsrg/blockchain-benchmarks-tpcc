...
public class EntityRegistry implements RegistryInterface {
  ...
  @Override
  public <Type extends SerializableEntityInterface<Type>> void create(Context ctx, Type entity, boolean strict) {
    if (strict) {
  ...
  @Override
  public <Type extends SerializableEntityInterface<Type>> void update(Context ctx, Type entity, boolean strict) {
  ...
  @Override
  public <Type extends SerializableEntityInterface<Type>> void delete(Context ctx, Type entity, boolean strict) {
  ...
  @Override
  public <Type extends SerializableEntityInterface<Type>> List<Type> readAll(Context ctx, Type entityTemplate) {

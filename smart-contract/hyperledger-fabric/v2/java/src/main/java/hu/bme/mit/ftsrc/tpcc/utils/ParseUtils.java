...
package hu.bme.mit.ftsrc.tpcc.utils;

import com.google.gson.Gson;

import hu.bme.mit.ftsrc.tpcc.TPCC;
import hu.bme.mit.ftsrc.tpcc.entries.Customer;
import hu.bme.mit.ftsrc.tpcc.entries.District;
import hu.bme.mit.ftsrc.tpcc.entries.History;
import hu.bme.mit.ftsrc.tpcc.entries.Item;
import hu.bme.mit.ftsrc.tpcc.entries.NewOrder;
import hu.bme.mit.ftsrc.tpcc.entries.Order;
import hu.bme.mit.ftsrc.tpcc.entries.OrderLine;
import hu.bme.mit.ftsrc.tpcc.entries.Stock;
import hu.bme.mit.ftsrc.tpcc.entries.Warehouse;
import hu.bme.mit.ftsrc.tpcc.inputs.DeliveryParameters;
import hu.bme.mit.ftsrc.tpcc.inputs.NewOrderParameters;
import hu.bme.mit.ftsrc.tpcc.inputs.OrderStatusParameters;
import hu.bme.mit.ftsrc.tpcc.inputs.PaymentParameters;
import hu.bme.mit.ftsrc.tpcc.inputs.StockLevelParameters;

...
package hu.bme.mit.ftsrc.tpcc.entries;
...
public class District {
  ...
  // public District(int d_id, int d_w_id, String d_name, String d_street_1, String d_street_2,
  // String d_city, String d_state, String d_zip, int d_tax, int d_ytd, int d_next_o_id){
  //     this.d_id = d_id;
  //     this.d_w_id = d_w_id;
  //     this.d_name = d_name;

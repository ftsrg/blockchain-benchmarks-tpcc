...
public interface RegistryInterface {
  ...
  <Type extends SerializableEntityInterface<Type>> void create(
      Context ctx, Type entity, boolean strict);

  <Type extends SerializableEntityInterface<Type>> void update(
      Context ctx, Type entity, boolean strict);

  <Type extends SerializableEntityInterface<Type>> void delete(
      Context ctx, Type entity, boolean strict);
